...
public class ATM{
    public static void main(String[]args){
        ...
        //init bank
        Bank theBank = new Bank("G7 Bank of Trust");
        //add user ,which also creates a savings account
        User aUser = theBank.addUser("Tony","Ballon","1111");
    ...
    public static void depositeFunds(User theUser,Scanner sc){
        ...
        //get the account to transfer from
        do{
            System.out.printf("Enter the number (1-%d) of the account\n"+"Where to Deposit:",theUser.numAccounts());
            toAct = sc.nextInt()-1;
            if(toAct < 0 || toAct >= theUser.numAccounts()){
                System.out.println("Invalid account. please try again.....");
            }
        ...
        //get the amount to transfer
        do{
            System.out.print("Enter the amount to deposit (max than $"+actBal+") :$");
            amount = sc.nextDouble();
            if(amount < 0){
                System.out.println("Amount must be greater than zero");
            }
